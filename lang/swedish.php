...
$_LANG['cPanel']['addonDomains'] = "Addon-domäner";
...
$_LANG['cPanel']['subdomains'] = "Underdomäner";
...
$_LANG['store']['ssl']['landingPage']['chooseLevel'] = "Välj din valideringsnivå";
...
$_LANG['store']['ssl']['landingPage']['dvInformation'] = "Endast domänvalidering. Utfärdad på några minuter. Perfekt för bloggar, sociala medier och personliga webbplatser.";
$_LANG['store']['ssl']['landingPage']['dvSubtitle'] = "Grundläggande säkerhet";
...
$_LANG['store']['ssl']['landingPage']['evInformation'] = "Fullständig identitetsverifiering. Perfekt för affärs- och e-handelswebbplatser som vill ge maximal besökares förtroende.";
$_LANG['store']['ssl']['landingPage']['evSubtitle'] = "Maximalt skydd och förtroende";
...
$_LANG['store']['ssl']['landingPage']['evs']['learn'] = "Läs mer om SSL-certifikat för utökad validering";
$_LANG['store']['ssl']['landingPage']['evs']['upgradeTitle'] = "Uppgradera till SSL med utökad validering";
$_LANG['store']['ssl']['landingPage']['evs']['whatIs'] = "<strong>Extended Validation Certificate</strong> erbjuder den högsta nivån av validering och förtroende. De validerar och visar namn och plats för företag och organisationer för att ge kunderna extra förtroende när de handlar med företag online.";
...
$_LANG['store']['ssl']['shared']['wildcardSsl'] = "Jokertecken";
