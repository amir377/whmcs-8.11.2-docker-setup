...
$_LANG['cPanel']['addonDomains'] = "Doplňkové domény";
...
$_LANG['cPanel']['subdomains'] = "Subdomény";
...
$_LANG['store']['ssl']['dv']['descriptionTitle'] = "Co je standardní DV SSL?";
...
$_LANG['store']['ssl']['landingPage']['chooseLevel'] = "Vyberte si úroveň ověření";
...
$_LANG['store']['ssl']['landingPage']['dvInformation'] = "Pouze ověření domény. Vydáno během několika minut. Ideální pro blogy, sociální média a osobní webové stránky.";
$_LANG['store']['ssl']['landingPage']['dvSubtitle'] = "Základní zabezpečení";
...
$_LANG['store']['ssl']['landingPage']['evInformation'] = "Úplné ověření totožnosti. Ideální pro obchodní a elektronický obchod, které chtějí poskytnout maximální důvěru návštěvníků.";
$_LANG['store']['ssl']['landingPage']['evSubtitle'] = "Maximální ochrana a důvěra";
...
$_LANG['store']['ssl']['landingPage']['evs']['learn'] = "Další informace o certifikátech SSL s rozšířenou validací";
$_LANG['store']['ssl']['landingPage']['evs']['upgradeTitle'] = "Upgrade na SSL s rozšířenou validací";
$_LANG['store']['ssl']['landingPage']['evs']['whatIs'] = "<strong>Certifikáty rozšířené validace</strong> nabízejí nejvyšší úroveň ověření a důvěry. Ověřují a zobrazují název a umístění společností a organizací, aby zákazníkům poskytly větší důvěru při jednání s podniky online.";
...
$_LANG['store']['ssl']['shared']['dvSsl'] = "Standardní SSL (DV)";
...
$_LANG['store']['ssl']['shared']['ovSsl'] = "Validace organizace (OV)";
...
$_LANG['store']['ssl']['shared']['wildcardSsl'] = "Zástupný znak";
