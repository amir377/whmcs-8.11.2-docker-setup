...
$_LANG['store']['ssl']['landingPage']['chooseLevel'] = "Vælg dit valideringsniveau";
...
$_LANG['store']['ssl']['landingPage']['dvInformation'] = "Kun domænevalidering. Udstedt på få minutter. Ideel til blogs, sociale medier og personlige hjemmesider.";
$_LANG['store']['ssl']['landingPage']['dvSubtitle'] = "Grundlæggende sikkerhed";
...
$_LANG['store']['ssl']['landingPage']['evInformation'] = "Fuld identitetsbekræftelse. Ideel til forretnings- og e-handelswebsteder, der ønsker at give maksimal tillid til besøgende.";
$_LANG['store']['ssl']['landingPage']['evSubtitle'] = "Maksimal beskyttelse og tillid";
...
$_LANG['store']['ssl']['landingPage']['evs']['learn'] = "Få mere at vide om SSL-certifikater med udvidet validering";
$_LANG['store']['ssl']['landingPage']['evs']['upgradeTitle'] = "Opgrader til SSL med udvidet validering";
$_LANG['store']['ssl']['landingPage']['evs']['whatIs'] = "<strong>Udvidede valideringscertifikater</strong> tilbyder det højeste niveau af validering og tillid. De validerer og viser navn og placering af virksomheder og organisationer for at give kunderne ekstra tillid, når de handler med virksomheder online.";
...
$_LANG['store']['ssl']['shared']['wildcardSsl'] = "Jokertegn";
