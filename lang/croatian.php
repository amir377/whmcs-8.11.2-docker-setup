...
$_LANG['cPanel']['addonDomains'] = "Dodatne domene";
...
$_LANG['cPanel']['subdomains'] = "Poddomene";
...
$_LANG['store']['ssl']['dv']['descriptionTitle'] = "Što je standardni DV SSL?";
...
$_LANG['store']['ssl']['landingPage']['dvInformation'] = "Samo provjera valjanosti domene. Izdano u nekoliko minuta. Idealno za blogove, društvene medije i osobne web stranice.";
$_LANG['store']['ssl']['landingPage']['dvSubtitle'] = "Osnovna sigurnost";
...
$_LANG['store']['ssl']['landingPage']['evInformation'] = "Potpuna provjera identiteta. Idealno za web stranice za poslovanje i e-trgovinu koje žele pružiti maksimalno povjerenje posjetitelja.";
$_LANG['store']['ssl']['landingPage']['evSubtitle'] = "Maksimalna zaštita i povjerenje";
...
$_LANG['store']['ssl']['landingPage']['evs']['learn'] = "Saznajte više o SSL certifikatima proširene provjere valjanosti";
$_LANG['store']['ssl']['landingPage']['evs']['upgradeTitle'] = "Nadogradnja na SSL proširene provjere valjanosti";
$_LANG['store']['ssl']['landingPage']['evs']['whatIs'] = "<strong>Certifikati proširene provjere valjanosti</strong> nude najvišu razinu provjere valjanosti i povjerenja. Oni potvrđuju i prikazuju ime i lokaciju tvrtki i organizacija kako bi kupcima pružili dodatno povjerenje kada se bave tvrtkama na mreži.";
...
$_LANG['store']['ssl']['shared']['wildcardSsl'] = "Zamjenski znak";
