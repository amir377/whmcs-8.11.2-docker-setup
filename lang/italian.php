...
$_LANG['store']['ssl']['landingPage']['chooseLevel'] = "Scegli il tuo livello di convalida";
...
$_LANG['store']['ssl']['landingPage']['dvInformation'] = "Solo convalida del dominio. Emesso in pochi minuti. Ideale per blog, social media e siti Web personali.";
$_LANG['store']['ssl']['landingPage']['dvSubtitle'] = "Sicurezza di base";
...
$_LANG['store']['ssl']['landingPage']['evInformation'] = "Verifica completa dell'identità. Ideale per siti aziendali ed e-commerce che cercano di offrire la massima fiducia ai visitatori.";
$_LANG['store']['ssl']['landingPage']['evSubtitle'] = "Massima protezione e fiducia";
...
$_LANG['store']['ssl']['landingPage']['evs']['learn'] = "Scopri di più sui certificati SSL a convalida estesa";
$_LANG['store']['ssl']['landingPage']['evs']['upgradeTitle'] = "Aggiornamento a Extended Validation SSL";
$_LANG['store']['ssl']['landingPage']['evs']['whatIs'] = "<strong>I certificati di convalida estesa</strong> offrono il massimo livello di convalida e affidabilità. Convalidano e mostrano il nome e l'ubicazione di aziende e organizzazioni per dare ai clienti maggiore sicurezza quando hanno a che fare con le aziende online.";
