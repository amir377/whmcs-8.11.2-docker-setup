...
$_LANG['store']['ssl']['landingPage']['chooseLevel'] = "Doğrulama seviyenizi seçin";
...
$_LANG['store']['ssl']['landingPage']['dvInformation'] = "Yalnızca etki alanı doğrulaması. Dakikalar içinde yayınlandı. Bloglar, sosyal medya ve kişisel web siteleri için idealdir.";
$_LANG['store']['ssl']['landingPage']['dvSubtitle'] = "Temel Güvenlik";
...
$_LANG['store']['ssl']['landingPage']['evInformation'] = "Tam kimlik doğrulaması. Maksimum ziyaretçi güvenini sağlamak isteyen İş ve E-ticaret siteleri için idealdir.";
$_LANG['store']['ssl']['landingPage']['evSubtitle'] = "Maksimum Koruma ve Güven";
...
$_LANG['store']['ssl']['landingPage']['evs']['learn'] = "Genişletilmiş Doğrulama SSL Sertifikaları hakkında daha fazla bilgi edinin";
$_LANG['store']['ssl']['landingPage']['evs']['upgradeTitle'] = "Genişletilmiş Doğrulama SSL'ye yükseltin";
$_LANG['store']['ssl']['landingPage']['evs']['whatIs'] = "<strong>Genişletilmiş Doğrulama Sertifikaları</strong> en yüksek düzeyde doğrulama ve güven sunar. Müşterilere çevrimiçi işletmelerle uğraşırken daha fazla güven vermek için şirketlerin ve kuruluşların adını ve konumunu doğrular ve gösterirler.";
...
$_LANG['store']['ssl']['shared']['wildcardSsl'] = "Joker karakter";
