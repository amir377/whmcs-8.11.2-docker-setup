...
$_LANG['store']['ssl']['landingPage']['chooseLevel'] = "Escolha seu nível de validação";
...
$_LANG['store']['ssl']['landingPage']['dvInformation'] = "Somente validação de domínio. Emitido em minutos. Ideal para blogs, mídias sociais e sites pessoais.";
...
$_LANG['store']['ssl']['landingPage']['evInformation'] = "Verificação completa de identidade. Ideal para sites de negócios e comércio eletrônico que buscam oferecer a máxima confiança ao visitante.";
...
$_LANG['store']['ssl']['landingPage']['evs']['upgradeTitle'] = "Atualize para SSL de validação estendida";
$_LANG['store']['ssl']['landingPage']['evs']['whatIs'] = "Os certificados de validação estendida <strong></strong> oferecem o mais alto nível de validação e confiança. Eles validam e exibem o nome e a localização de empresas e organizações para dar aos clientes mais confiança ao lidar com negócios on-line.";
