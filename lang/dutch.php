...
$_LANG['activateNowFor'] = "Activeer nu voor :price";
...
$_LANG['affiliatesWithdrawalRequestUnsuccessful'] = "Je verzoek om uitbetaling is niet gelukt. Probeer het later nog eens.";
...
$_LANG['billingOverview'] = "Overzicht van de facturering";
...
$_LANG['captcha']['hcaptcha']['tagLine'] = "Beschermd door hCaptcha®";
$_LANG['captcha']['verification']['failed'] = "Captcha-verificatie is mislukt. Neem contact op met de klantenservice voor meer informatie.";
$_LANG['captchaIncorrect'] = "Voltooi de captcha en probeer het opnieuw.";
...
$_LANG['captchaverifyincorrect'] = "De tekens die u hebt ingevoerd, kwamen niet overeen met de weergegeven afbeelding. Probeer het nog eens.";
...
$_LANG['clientAlerts']['servicesRenewingSoon'] = "Je hebt :numberOfServices service (s) die binnenkort kunnen worden verlengd.";
...
$_LANG['clientAreaSecurityTwoFactorAuthRequired'] = "Om de beveiliging van je account te garanderen, moet je tweefactorauthenticatie configureren.";
...
$_LANG['clientHomePanels']['serviceRenewingSoon'] = "Services worden binnenkort verlengd";
$_LANG['clientHomePanels']['serviceRenewingSoonMsg'] = "Je hebt :numberOfServices service (s) die binnenkort beschikbaar zijn voor verlenging. Vernieuw ze vandaag nog voor gemoedsrust.";
...
$_LANG['contactCreated'] = "Contactpersoon succesvol aangemaakt!";
$_LANG['contactDeleted'] = "Contactpersoon succesvol verwijderd!";
$_LANG['contactDetails'] = "Contactgegevens";
$_LANG['contactUpdated'] = "Contact succesvol bijgewerkt!";
...
$_LANG['customActionException'] = "Er is een uitzondering opgetreden. Neem contact op met de klantenservice.";
$_LANG['customActionGenericError'] = "Kan geen actie uitvoeren. Neem contact op met de klantenservice.";
...
$_LANG['domainCheckerSalesGroup']['sale'] = "Verkoop";
...
$_LANG['domainDnsSec']['digestType'] = "Soort samenvatting";
$_LANG['domainDnsSec']['dsRecords'] = "DS Records";
$_LANG['domainDnsSec']['flags'] = "Vlaggen";
$_LANG['domainDnsSec']['keyRecords'] = "BELANGRIJKSTE records";
$_LANG['domainDnsSec']['keyTag'] = "Sleutelhanger";
$_LANG['domainDnsSec']['management'] = "DNSSEC-beheer";
$_LANG['domainDnsSec']['protocol'] = "Protocol";
$_LANG['domainDnsSec']['publicKey'] = "Publieke sleutel";
$_LANG['domainDnsSec']['publicKeyNoSpace'] = "Public Key mag geen witruimte bevatten.";
...
$_LANG['domains']['europeanDomainTerms'] = "Belangrijke informatie met betrekking tot uw contactgegevens: We zijn contractueel verplicht om uw persoonlijke informatie te delen met het register voor dit TLD. We zullen uw persoonlijke informatie overdragen aan het register, dat deze mogelijk openbaar maakt in de WHOIS. Lees ons privacybeleid en de domeinregistratieovereenkomst voor meer informatie over waarom we uw persoonlijke gegevens delen.";
...
$_LANG['forwardingtogateway'] = "Even geduld a.u.b. terwijl het systeem u doorverwijst om de betaling te voltooien met de geselecteerde betaalmethode.";
...
$_LANG['idna']['domainTooLong'] = "Het domein heeft de maximale lengte overschreden.";
$_LANG['idna']['emptyLabel'] = "De invoer van de domeinnaam is leeg.";
$_LANG['idna']['invalidDomain'] = "Het domein is ongeldig.";
$_LANG['idna']['labelTooLong'] = "Het domeinlabel heeft de maximale lengte overschreden.";
$_LANG['idna']['unknownError'] = "Er is een onbekende fout opgetreden.";
...
$_LANG['markdown']['smith'] = "smid";
$_LANG['markdown']['spanningMultipleLines'] = "Of verspreid over meerdere lijnen...";
...
$_LANG['marketConnect']['emailServices']['manage'] = "Meld u aan bij SpamExperts";
...
$_LANG['marketConnect']['nordvpn']['clientOutput']['1'] = "Bedankt dat je NordVPN hebt gekocht om je persoonlijke en zakelijke gegevens te beveiligen. Je ontvangt binnenkort een e-mail van NordVPN met je activeringslink. Als je het niet in je inbox ziet, controleer dan je spammap.";
...
$_LANG['marketConnect']['ox']['manage'] = "Meld u aan bij OX App Suite";
...
$_LANG['marketConnect']['siteBuilder']['ftpPath'] = "FTP Pad";
...
$_LANG['marketConnect']['siteBuilder']['updateFtp'] = "FTP-referenties bijwerken";
...
$_LANG['marketConnect']['sitelockvpn']['manage'] = "Meld je aan bij SiteLock VPN";
...
$_LANG['marketConnect']['xoviNow']['manage'] = "Meld je NU aan bij XOVI";
...
$_LANG['navMarketConnectService']['threesixtymonitoring'] = "Monitoring van sites en servers";
...
$_LANG['orderForm']['reviewDomainAndAddons'] = "Controleer uw domeinnaamselecties en eventuele add-ons die daarvoor beschikbaar zijn.";
...
$_LANG['ox']['alias']['createSuccess'] = "Alias is succesvol aangemaakt.";
$_LANG['ox']['alias']['deleteQuestion'] = "Weet je zeker dat je deze alias wilt verwijderen?";
$_LANG['ox']['alias']['deleteSuccess'] = "Alias is succesvol verwijderd.";
$_LANG['ox']['alias']['deleteTitle'] = "Alias <span class=\"alias\"></span>@:domain verwijderen?";
$_LANG['ox']['alias']['emailAliases'] = "E-mailaliassen";
$_LANG['ox']['alias']['intro'] = "E-mailaliassen fungeren als extra e-mailadressen van waaruit u post kunt verzenden en ontvangen.";
...
$_LANG['ox']['deleteAccountWithAliasesQuestion'] = "Weet je zeker dat je dit account en eventuele aliassen wilt verwijderen?";
...
$_LANG['ox']['intro'] = "Hier kunt u gebruikers, mailboxen en aliassen aanmaken en beheren voor uw OX App Suite-abonnement.";
...
$_LANG['paypalCommerce']['error']['noAccount'] = "U moet een bestaande gekoppelde PayPal-rekening selecteren of een nieuwe account koppelen voordat u de betaling uitvoert.";
$_LANG['paypalCommerce']['linkAccount'] = "Een nieuw PayPal-account koppelen";
$_LANG['paypalCommerce']['payerApprovedInstructions'] = "Klik hieronder om het afrekenen met PayPal te voltooien.";
$_LANG['paypalCommerce']['payerApprovedPlaceholder'] = "Gekoppeld account";
$_LANG['paypalCommerce']['paymentInstructions'] = "Om de betaling met PayPal te voltooien, kiest u een bestaand gekoppeld PayPal-account of koppelt u een nieuw account.";
...
$_LANG['plesk']['applications'] = "Applicaties";
...
$_LANG['recommendations']['explain']['generic'] = "Op basis van je bestelling raden we aan:";
$_LANG['recommendations']['explain']['ordered'] = "Omdat je <strong>:productName</strong>hebt besteld, raden we aan:";
...
$_LANG['recommendations']['taglinePlaceholder'] = "Een beschrijving (slogan) is niet beschikbaar voor dit product.";
$_LANG['recommendations']['title']['addedTo'] = "Aan winkelwagen toegevoegd";
$_LANG['recommendations']['title']['generic'] = "Aanbevelingen";
$_LANG['recommendations']['title']['yourOrder'] = "Op basis van uw bestelling";
$_LANG['recommendations']['title']['yourProducts'] = "Gebaseerd op uw producten";
...
$_LANG['renewService']['hideShowServices']['hide'] = "Niet-hernieuwbare items verbergen";
$_LANG['renewService']['hideShowServices']['show'] = "Niet-hernieuwbare items weergeven";
$_LANG['renewService']['noServices'] = "Je hebt momenteel geen diensten die in aanmerking komen voor verlenging.";
...
$_LANG['renewService']['renewalUnavailable'] = "Verlenging niet beschikbaar";
$_LANG['renewService']['renewingIn'] = "Verlenging binnen :days dagen";
$_LANG['renewService']['searchPlaceholder'] = "Zoek op naam, domein of ID";
$_LANG['renewService']['serviceNextDueDateBasic'] = "Volgende uitgerekende datum: :nextDueDate";
$_LANG['renewService']['serviceNextDueDateExtended'] = "Volgende vervaldatum: :nextDueDate (:nextDueDateFormatted)";
$_LANG['renewService']['showingServices'] = "Toont :showing van :totalCount -services.";
$_LANG['renewService']['statusInfo']['metricUsage'] = "Dit is een service die voor het gebruik wordt gefactureerd en die geen ondersteuning biedt voor verlengingen op aanvraag.";
$_LANG['renewService']['statusInfo']['nonRecurring'] = "Dit is een eenmalige service waarbij geen gebruik wordt gemaakt van terugkerende facturering.";
$_LANG['renewService']['statusInfo']['notSupported'] = "Dit product ondersteunt geen verlengingen op aanvraag.";
$_LANG['renewService']['statusInfo']['outsideRenewal'] = "Deze service valt niet binnen de verlengingsperiode.";
$_LANG['renewService']['statusInfo']['serviceStatus'] = "Deze service is :serviceStatus. Voor verlengingen is een actieve status vereist.";
$_LANG['renewService']['statusInfo']['unpaidInvoices'] = "De service heeft :unpaidInvoiceCount onbetaalde factuur (en).";
$_LANG['renewService']['titleAltPlural'] = "Verlengingen van de service";
$_LANG['renewService']['titleAltSingular'] = "Vernieuwing van de service";
$_LANG['renewService']['titlePlural'] = "Services vernieuwen";
$_LANG['renewService']['titleSingular'] = "Service verlengen";
$_LANG['renewServiceAddon']['titleAltPlural'] = "Verlengingen van add-ons";
$_LANG['renewServiceAddon']['titleAltSingular'] = "Verlenging van de add-on";
...
$_LANG['sitejetBuilder']['chooseWebsite'] = "Kies een website om te beheren:";
$_LANG['sitejetBuilder']['dashboardPanelTitle'] = "Sitejet Builder";
$_LANG['sitejetBuilder']['editWebsite'] = "Website bewerken";
$_LANG['sitejetBuilder']['get']['title'] = "Koop Sitejet Builder";
...
$_LANG['sitejetBuilder']['servicePage']['publishProgress'] = "Publicatie in uitvoering...";
$_LANG['sitejetBuilder']['servicePage']['publishSuccess'] = "Succes! Je website is gepubliceerd.";
$_LANG['sitejetBuilder']['servicePage']['visitSite'] = "Bezoek";
$_LANG['sitejetBuilder']['upgradeTo']['title'] = "Upgrade naar Sitejet Builder";
$_LANG['sitejetBuilder']['upsellDescription'] = "Een krachtige websitebouwer met drag-and-drop die u helpt bij het bouwen en publiceren van uw website.";
...
$_LANG['ssl']['approverEmailProcess'] = "<h4>Over het e-mailproces van de goedkeurder</h4><p>Om een SSL-certificaat uit te geven, moet de certificaatautoriteit de authenticiteit van de certificaatbestelling valideren om er zeker van te zijn dat het verzoek legitiem is en afkomstig is van een bevoegde eigenaar van het domein.</p><p>Domeinvalidatie via e-mail is het meest gebruikte mechanisme voor certificaatvalidatie voor certificaatbestellingen. De certificeringsinstantie stelt een lijst samen van goedgekeurde e-mailadressen op basis van veelgebruikte administratieve e-mailadressen (bijvoorbeeld admin of webmaster) in combinatie met de openbare WHOIS-gegevens voor het domein. Je kunt slechts één van deze e-mailadressen gebruiken om het eigendom te bevestigen.</p>";
...
$_LANG['ssl']['approverEmailUpdateSuccess'] = "E-mailadres van de goedkeurder is succesvol bijgewerkt!";
$_LANG['ssl']['certError1'] = "U kunt het certificaat alleen ophalen nadat de certificeringsinstantie het heeft uitgegeven.";
$_LANG['ssl']['certError2'] = "Als u de configuratiegegevens onlangs hebt ingediend, geef de certificeringsinstantie dan de tijd om de beveiligingscontroles uit te voeren en het certificaat uit te geven. Voor DV-bestellingen is dit doorgaans minder dan 24 uur. OV- en EV-certificaten kunnen tot 3-5 dagen duren.";
...
$_LANG['ssl']['copyCert'] = "Kopieer je certificaat uit de onderstaande tekst:";
$_LANG['ssl']['copyTheSiteSeal'] = "Kopieer de zegelcode van uw site uit de onderstaande tekst:";
$_LANG['ssl']['dcv'] = "Validatie van domeinbeheer";
$_LANG['ssl']['defaultcontacts'] = "Standaarddomeincontactpersonen";
$_LANG['ssl']['disableWhoisPrivacy'] = "Schakel alle WHOIS-privacyservices uit voordat u verder gaat.";
...
$_LANG['ssl']['dnsRecordInformation'] = "DNS-recordinformatie";
...
$_LANG['ssl']['emailSteps'] = "The Certificate Authority will send an email to the email address below. It will contain further instructions needed to validate domain ownership. Once those steps are complete, the Certificate will be issued.";
$_LANG['ssl']['fileInformation'] = "Informatie over het bestand";
...
$_LANG['ssl']['howToInstall'] = "Om uw certificaat te installeren, uploadt u het certificaat hierboven naar uw server of controlepaneel. De methode om dit te doen is afhankelijk van je hostingomgeving.";
$_LANG['ssl']['howToUseSiteSeal'] = "Hoe de Site Seal Code te gebruiken";
...
$_LANG['ssl']['nextSteps'] = "Wat is de volgende stap";
$_LANG['ssl']['rapidSslInstructions'] = "Kopieer de HTML-afbeeldingstag naar uw HTML-document op de locatie waar u het RapidSSL-zegel wilt weergeven.";
$_LANG['ssl']['reissueCertificate'] = "Geef opnieuw uit";
$_LANG['ssl']['reissueInfo1'] = "Als u uw certificaat bent kwijtgeraakt, servers moet verplaatsen of een probleem hebt gehad met de installatie, kunt u uw certificaat opnieuw uitgeven om een nieuw certificaat te genereren.";
$_LANG['ssl']['reissueInfo2'] = "Wanneer u een certificaat opnieuw uitgeeft, kunt u de domeinnaam niet wijzigen en moet deze exact hetzelfde blijven.";
$_LANG['ssl']['reissueSuccess'] = "Verzoek om heruitgave succesvol ingediend!";
...
$_LANG['ssl']['retrieved'] = "Het systeem heeft uw certificaat succesvol opgehaald.";
$_LANG['ssl']['sealSuccess'] = "De zegelcode van uw site is succesvol opgehaald.";
$_LANG['ssl']['selectDcvEmail'] = "Selecteer een actief e-mailadres uit de onderstaande lijst. Je ontvangt een e-mail om het SSL-certificaat goed te keuren.";
...
$_LANG['ssl']['siteSealError1'] = "U kunt de HTML-code van het zegel alleen ophalen nadat de certificeringsinstantie het certificaat heeft uitgegeven.";
$_LANG['ssl']['siteSealInstructions1'] = "Kopieer de HTML-sectie van DigiCert Seal en plak deze in uw HTML-document op de locatie waar u het zegel van uw site wilt weergeven.";
$_LANG['ssl']['siteSealInstructions2'] = "Kopieer de sectie DigiCert Seal Code en plak deze in de HEAD-sectie van uw HTML-document.";
...
$_LANG['ssl']['status']['reissued'] = "Heruitgegeven";
$_LANG['ssl']['type'] = "Typ";
$_LANG['ssl']['url'] = "URL";
$_LANG['ssl']['value'] = "Waarde";
$_LANG['ssl']['x500DN']['commonName'] = "Algemene naam";
...
$_LANG['ssl']['x500DN']['organizationUnit'] = "Eenheid van de organisatie";
...
$_LANG['sslinstantissuancebenefit'] = "Uw bestelling is geprofiteerd van Immediate Issuance";
...
$_LANG['store']['addon']['wptk']['faqA1'] = "WP Toolkit is een beheerinterface voor WordPress van cPanel en Plesk waarmee u WordPress-websites kunt installeren, configureren en beheren.";
...
$_LANG['store']['addon']['wptk']['plesk']['featureTitle2'] = "Fase en test";
...
$_LANG['store']['codeGuard']['title'] = "CodeGuard reservekopie";
...
$_LANG['store']['marketgoo']['cartTitle'] = "Marketgoo SEO Hulpmiddelen";
...
$_LANG['store']['marketgoo']['labelBestValue'] = "Beste prijs!";
$_LANG['store']['marketgoo']['promo']['sidebar']['body'] = "Verbeter het verkeer naar uw site en laat uw bedrijf groeien";
$_LANG['store']['marketgoo']['promo']['sidebar']['title'] = "Marketgoo SEO Hulpmiddelen";
...
$_LANG['store']['nordvpn']['cartShortDescription'] = "NordVPN maakt anonieme, versleutelde browsersessies via elke netwerkverbinding mogelijk.";
...
$_LANG['store']['nordvpn']['features']['comparison']['title'] = "Waarom kiezen voor NordVPN?";
...
$_LANG['store']['nordvpn']['features']['device']['tagline1'] = "Er zijn geen snelheidsbeperkingen aan onze kant. Geniet van je snelle VPN-verbinding zonder enige beperking.";
$_LANG['store']['nordvpn']['features']['device']['tagline2'] = "NordVPN is compatibel met alle populaire platforms, waaronder Windows, MacOS, Linux, Android en iOS. Bovendien kunt u met één account maximaal 6 apparaten beveiligen, inclusief uw router.";
$_LANG['store']['nordvpn']['features']['device']['title1'] = "Geen bandbreedtelimieten";
$_LANG['store']['nordvpn']['features']['device']['title2'] = "Werkt op alle apparaten";
$_LANG['store']['nordvpn']['features']['faq']['answer1'] = "Een :tagOpenvirtual -privénetwerk:tagClose leidt uw internetverkeer door een beveiligde tunnel, waarbij uw virtuele locatie wordt gewijzigd. Maar NordVPN is meer dan alleen een VPN &mdash; , we bieden ook krachtige antimalwaretools.";
$_LANG['store']['nordvpn']['features']['faq']['answer2'] = "VPN Fail-Safe-schakelaar. Als de VPN-verbinding wegvalt, blokkeert Kill Switch het verzenden van onbeveiligde gegevens op je apparaat.";
$_LANG['store']['nordvpn']['features']['faq']['answer3'] = "De Threat Protection-functie van NordVPN maakt je veel veiliger tegen online bedreigingen. Zet het aan en Threat Protection blokkeert opdringerige advertenties en trackers, scant URL's om je te beschermen tegen gevaarlijke websites en inspecteert gedownloade bestanden op malware. Ervaar het internet zonder opdringerige tracking of censuur. Blijf veilig op wifi-netwerken en voorkom dat je mobiele apps onversleutelde gegevens lekken. Krijg het allemaal met slechts één klik op de knop.";
$_LANG['store']['nordvpn']['features']['faq']['answer4'] = "Beschermt uw online activiteiten voor het geval DNS-servers niet-versleutelde zoekopdrachten buiten een beveiligde VPN-tunnel verzenden.";
$_LANG['store']['nordvpn']['features']['faq']['answer5'] = "Dubbele versleuteling. Wanneer een hoog niveau van beveiliging en privacy nodig is.";
$_LANG['store']['nordvpn']['features']['faq']['question1'] = "Wat is een VPN?";
$_LANG['store']['nordvpn']['features']['faq']['question2'] = "Wat is een Auto-Kill Switch?";
$_LANG['store']['nordvpn']['features']['faq']['question3'] = "Wat is de bedreigingsbescherming van NordVPN?";
$_LANG['store']['nordvpn']['features']['faq']['question4'] = "Wat is DNS-lekbescherming?";
...
$_LANG['store']['nordvpn']['features']['icon']['bug2'] = "Ontvang waarschuwingen over onveilige sites en scan automatisch alle gedownloade bestanden en bijlagen op malware. Als ze niet veilig kunnen worden geopend, worden ze automatisch verwijderd om schade aan je apparaat te voorkomen.";
$_LANG['store']['nordvpn']['features']['icon']['check1'] = "Veilige, snelle VPN";
$_LANG['store']['nordvpn']['features']['icon']['check2'] = "Versleutel je internetverbinding, win digitale privacy terug en krijg toegang tot je favoriete content met de snelste VPN op de markt. Kies uit VPN-servers in 59 landen en bescherm tot 6 apparaten tegelijk.";
$_LANG['store']['nordvpn']['features']['icon']['global'] = "Bekijk thuisshows en sport vanuit het buitenland";
$_LANG['store']['nordvpn']['features']['icon']['hacker'] = "Bescherm tegen hackers op onbeveiligde netwerken (zoals openbare wifi®)";
$_LANG['store']['nordvpn']['features']['icon']['property'] = "Verminder online tracking door uw IP-adres te verbergen";
$_LANG['store']['nordvpn']['features']['icon']['shield1'] = "Tracker en adblocker";
$_LANG['store']['nordvpn']['features']['icon']['shield2'] = "Blokkeer vervelende advertenties, pop-ups en banners en voorkom dat websites van derden uw online activiteiten volgen. Geniet van een veiligere, soepelere en snellere surfervaring op alle sites en op elk apparaat.";
$_LANG['store']['nordvpn']['features']['icon']['title1'] = "Met een VPN kun je:";
$_LANG['store']['nordvpn']['features']['icon']['title2'] = "Houd je gegevens veilig";
$_LANG['store']['nordvpn']['features']['icon']['video'] = "Inhoud bekijken, streamen en downloaden met een veilige en privéverbinding";
$_LANG['store']['nordvpn']['features']['pricing']['get'] = "Aan de slag";
$_LANG['store']['nordvpn']['features']['pricing']['save'] = "Bespaar :amount%!";
$_LANG['store']['nordvpn']['features']['pricing']['title'] = "Kies hoe je betaalt:";
$_LANG['store']['nordvpn']['features']['security']['tagline1'] = "Als je bescherming wilt tegen hackers en online monitoring, kun je je verbinding veiliger maken met een virtual private network (VPN) van NordVPN.";
...
$_LANG['store']['nordvpn']['features']['security']['tagline3'] = "NordVPN beveiligt je verbinding met versleuteling van de volgende generatie, zodat je zonder zorgen kunt inloggen op je accounts, bankoverschrijvingen kunt doen en online kunt winkelen. Zelfs op onbeveiligde wifi.";
...
$_LANG['store']['nordvpn']['features']['security']['title1'] = "Verhoog je online beveiliging met een VPN";
$_LANG['store']['nordvpn']['features']['security']['title2'] = "Ultieme beveiliging";
$_LANG['store']['nordvpn']['features']['security']['title3'] = "Beleid zonder logboeken";
$_LANG['store']['nordvpn']['features']['security']['title4'] = "Extra functies voor extra beveiliging";
...
$_LANG['store']['nordvpn']['features']['threat']['title'] = "Meer dan alleen een VPN";
...
$_LANG['store']['nordvpn']['features']['use']['tagline5'] = "Hoewel online platforms overal ter wereld toegankelijk zijn, zijn bepaalde uitzendingen, shows of sportevenementen vaak beperkt.";
$_LANG['store']['nordvpn']['features']['use']['tagline6'] = "Online advertenties maken uw surfervaring meestal veel slechter. Ze maken grote delen van websites rommelig, vertragen de downloadsnelheden en kunnen bronnen van malware zijn.";
$_LANG['store']['nordvpn']['features']['use']['tagline7'] = "Smart home-technologieën en in het bijzonder onveilige IoT-apparaten kunnen kwetsbaarheden creëren voor thuisnetwerken.";
$_LANG['store']['nordvpn']['features']['use']['title1'] = "Use cases";
$_LANG['store']['nordvpn']['features']['use']['title2'] = "Wi-Fi op openbare plaatsen";
$_LANG['store']['nordvpn']['features']['use']['title3'] = "Browsen beschermen tegen derden";
$_LANG['store']['nordvpn']['features']['use']['title4'] = "Overal toegang tot sociale mediaplatforms";
$_LANG['store']['nordvpn']['features']['use']['title5'] = "Geniet van online entertainment en live sport";
$_LANG['store']['nordvpn']['features']['use']['title6'] = "Bescherm je apparaat tegen kwaadaardige advertenties";
$_LANG['store']['nordvpn']['features']['use']['title7'] = "Beveilig je slimme gadgets voor thuis";
$_LANG['store']['nordvpn']['features']['world']['bullet1'] = "VPN-servers";
$_LANG['store']['nordvpn']['features']['world']['bullet2'] = "Landen";
$_LANG['store']['nordvpn']['features']['world']['bullet3'] = "Razendsnelle snelheden";
...
$_LANG['store']['nordvpn']['features']['world']['getDeal'] = "Grijp de deal";
...
$_LANG['store']['nordvpn']['manageService'] = "Beheer je NordVPN-service";
$_LANG['store']['nordvpn']['promo']['sidebar']['body'] = "Cyberbeveiliging ontworpen voor elke dag.";
$_LANG['store']['nordvpn']['promo']['sidebar']['title'] = "NordVPN-beveiliging";
$_LANG['store']['nordvpn']['shared']['get'] = "Koop NordVPN";
$_LANG['store']['nordvpn']['tagline'] = "Krijg onbeperkte toegang tot internet zonder privacyproblemen, inhoudsbeperkingen of datalimieten.";
...
$_LANG['store']['ox']['pricing']['features']['migration'] = "Hulpmiddel voor zelfbediening voor migratie";
...
$_LANG['store']['ox']['pricing']['features']['sla'] = "SLA voor een uptime van 99,9%";
...
$_LANG['store']['siteBuilder']['features']['essentials']['1'] = "Editor voor slepen en neerzetten";
...
$_LANG['store']['siteBuilder']['featuresLabels']['2'] = "Eenvoudig bewerken met slepen en neerzetten";
...
$_LANG['store']['siteBuilder']['templates']['eCommerce'] = "E-commercesjablonen";
...
$_LANG['store']['siteBuilder']['templates']['wedding-planner'] = "Huwelijksplanner";
...
$_LANG['store']['siteBuilder']['upgrade']['title'] = "Upgrade van de Site Builder";
...
$_LANG['store']['sitelock']['features']['contentAcceleration'] = "Versnelling van de inhoud";
...
$_LANG['store']['sitelock']['features']['spamBlacklistMonitoring'] = "Monitoring van zwarte lijsten voor spam";
...
$_LANG['store']['sitelock']['features']['wordPressScan'] = "Scannen met WordPress";
$_LANG['store']['sitelock']['features']['xssScan'] = "Scannen op meerdere locaties (XSS)";
...
$_LANG['store']['sitelock']['featuresMalwareTitle'] = "Malwarescan";
...
$_LANG['store']['ssl']['competitiveUpgrade'] = "Competitieve upgrade";
...
$_LANG['store']['ssl']['landingPage']['faq']['a5'] = "EV- of Extended Validation-certificaten zijn de hoogste SSL-klasse die beschikbaar is en geven uw website de meeste geloofwaardigheid en vertrouwen. EV verzekert consumenten dat hun persoonlijke en financiële informatie op het hoogste niveau van authenticatie wordt beschermd. Er worden aanvullende verificaties uitgevoerd, zoals controles van de dossiers van de bedrijfsagentschappen, contactgegevens van sollicitanten en of het bedrijf minimaal 3 jaar bestaat. EV-certificaten zijn het meest geschikt voor bedrijfskritische webpagina's.";
...
$_LANG['store']['ssl']['landingPage']['multiYear']['benefits']['b1'] = "Geniet van stijgende kortingen voor elk jaar dekking dat u koopt.";
$_LANG['store']['ssl']['landingPage']['multiYear']['benefits']['b2'] = "Maak een einde aan het gedoe van jaarlijkse facturering.";
$_LANG['store']['ssl']['landingPage']['multiYear']['benefits']['b3'] = "Jaarlijkse validatie. Jaarlijkse validatie van identiteit in certificaten met een kortere geldigheidsduur voorkomt mogelijke fraude en spoofing.";
$_LANG['store']['ssl']['landingPage']['multiYear']['benefits']['title'] = "Voordelen";
$_LANG['store']['ssl']['landingPage']['multiYear']['p1'] = "Met meerjarige certificaten kunt u één kortingsprijs betalen voor twee of drie jaar SSL-certificaatdekking. Wanneer u een meerjarig SSL-certificaat aanschaft, bent u verzekerd van één prijs voor een dekking van maximaal 3 jaar.";
$_LANG['store']['ssl']['landingPage']['multiYear']['p2'] = "In eerste instantie ontvangt u een certificaat dat geldig is voor de maximaal toegestane termijn van het Certificate Authority Browser Forum (1 jaar en 1 maand) met het recht op onbeperkte heruitgifte van certificaten tijdens de bestelperiode.";
$_LANG['store']['ssl']['landingPage']['multiYear']['p3'] = "Geautomatiseerde heruitgifte vindt gedurende de looptijd automatisch plaats om een blijvende bescherming van uw website te garanderen.";
$_LANG['store']['ssl']['landingPage']['multiYear']['p4'] = "Een bestelling van een SSL-certificaat voor 2 jaar werkt bijvoorbeeld als volgt:";
$_LANG['store']['ssl']['landingPage']['multiYear']['p5'] = "SSL-certificaten moeten periodiek opnieuw worden gevalideerd. De maximale levensduur van het certificaat is 13 maanden en moet jaarlijks opnieuw worden gevalideerd.";
...
$_LANG['store']['ssl']['shared']['dvSsl'] = "Standaard SSL (DV)";
...
$_LANG['store']['ssl']['shared']['ovSsl'] = "Validatie van de organisatie (OV)";
...
$_LANG['store']['threesixtymonitoring']['button']['startMonitoringLong'] = "Begin met het monitoren van je website";
$_LANG['store']['threesixtymonitoring']['button']['startMonitoringShort'] = "Begin met monitoren";
$_LANG['store']['threesixtymonitoring']['cartShortDescription'] = "Een betrouwbare en uitgebreide oplossing voor monitoring op meerdere servers en meerdere locaties.";
...
$_LANG['store']['threesixtymonitoring']['comparison']['crawlDepth'] = "Kruipdiepte (URL's)";
$_LANG['store']['threesixtymonitoring']['comparison']['dataRetention'] = "Bewaring van gegevens";
...
$_LANG['store']['threesixtymonitoring']['comparison']['startingFrom'] = "Beginnend vanaf";
$_LANG['store']['threesixtymonitoring']['comparison']['tagAdvanced'] = "Ideaal voor 10 locaties";
$_LANG['store']['threesixtymonitoring']['comparison']['tagBusiness'] = "Grote werklasten";
$_LANG['store']['threesixtymonitoring']['comparison']['tagEnterprise'] = "Monitoring op grote schaal";
$_LANG['store']['threesixtymonitoring']['comparison']['tagLine'] = "";
$_LANG['store']['threesixtymonitoring']['comparison']['tagLite'] = "Gratis 1 site";
$_LANG['store']['threesixtymonitoring']['comparison']['tagPersonal'] = "Ideaal voor 1 site ";
$_LANG['store']['threesixtymonitoring']['comparison']['tagPlus'] = "Ideaal voor 3 locaties";
...
$_LANG['store']['threesixtymonitoring']['faq']['a1'] = "Website Monitoring test websites op uptime, prestaties en algemene werking. Het controleert of uw site actief is en toegankelijk is voor bezoekers. Met de resultaten van Website Monitoring kunt u eventuele problemen met uw site oplossen voordat deze gevolgen hebben voor uw bedrijf.";
$_LANG['store']['threesixtymonitoring']['faq']['a10'] = "Server Monitoring voert regelmatig scans uit en houdt de status van uw server bij, inclusief CPU, laadtijden, netwerkstatistieken, geheugen, schijfgebruik en meer om u te helpen problemen snel op te sporen en op te lossen.";
$_LANG['store']['threesixtymonitoring']['faq']['a11'] = "Full Site Check beschermt je online aanwezigheid tegen fouten. Het crawlt je hele website of webwinkel en identificeert dode links, kapotte afbeeldingen, JavaScript-fouten en nog veel meer anomalieën, waardoor websiteproblemen worden voorkomen.";
$_LANG['store']['threesixtymonitoring']['faq']['a2'] = "Website Monitoring voert regelmatig tests uit op uw website (elke 1, 5 of 10 minuten, afhankelijk van uw abonnement). Deze tests detecteren problemen met je website. Wanneer een probleem wordt gedetecteerd, stuurt 360 Monitoring een waarschuwing en registreert het probleem voor latere analyse.";
$_LANG['store']['threesixtymonitoring']['faq']['a3'] = "Tools en processen voor prestatiebewaking controleren hoe goed het systeem werkt door systeembronnen zoals CPU-gebruik, geheugenverbruik, schijfgebruik, invoer-/uitvoerprestaties (I/O) en netwerkuptime te controleren. 360 Monitoring houdt al deze statistieken bij om ervoor te zorgen dat alles soepel verloopt.";
$_LANG['store']['threesixtymonitoring']['faq']['a4'] = "Prestatiemonitoring is cruciaal om prestatieproblemen te identificeren voordat ze uw bedrijf schaden. Dankzij de bevindingen op het gebied van systeembronnen kunt u ook proactief plannen voor uw toekomstige behoeften.";
$_LANG['store']['threesixtymonitoring']['faq']['a5'] = "Met SSL Monitoring kunt u uw SSL-certificaten volgen en vooraf plannen voor vervaldatums, zodat u verzekerd bent van naadloos certificaatbeheer.";
$_LANG['store']['threesixtymonitoring']['faq']['a6'] = "U kunt overal ter wereld monitoring uitvoeren, met bewakingslocaties in Australië, Canada, Finland, Frankrijk, Duitsland, Japan, Mexico, Nederland, Zweden, het Verenigd Koninkrijk en de Verenigde Staten.";
...
$_LANG['store']['threesixtymonitoring']['faq']['a8'] = "Ja, je kunt je abonnement op elk gewenst moment upgraden.";
$_LANG['store']['threesixtymonitoring']['faq']['a9'] = "Alle betaalde abonnementen maken onbeperkte meldingen via meerdere kanalen mogelijk. Sommige providers brengen mogelijk extra kosten in rekening voor dataverbruik of sms-berichten.";
$_LANG['store']['threesixtymonitoring']['faq']['q1'] = "Wat is website monitoring?";
$_LANG['store']['threesixtymonitoring']['faq']['q10'] = "Wat is serverbewaking?";
$_LANG['store']['threesixtymonitoring']['faq']['q11'] = "Wat is Full Site Check?";
$_LANG['store']['threesixtymonitoring']['faq']['q2'] = "Hoe werkt Website Monitoring?";
$_LANG['store']['threesixtymonitoring']['faq']['q3'] = "Hoe werkt Performance Monitoring?";
$_LANG['store']['threesixtymonitoring']['faq']['q4'] = "Waarom is prestatiemonitoring belangrijk?";
$_LANG['store']['threesixtymonitoring']['faq']['q5'] = "Hoe werkt SSL Monitoring?";
$_LANG['store']['threesixtymonitoring']['faq']['q6'] = "Welke locaties worden ondersteund voor monitoring?";
...
$_LANG['store']['threesixtymonitoring']['faq']['q9'] = "Zijn er extra kosten voor meldingen?";
$_LANG['store']['threesixtymonitoring']['faq']['title'] = "FAQ";
$_LANG['store']['threesixtymonitoring']['modal']['concern'] = "Bezorgdheid";
...
$_LANG['store']['threesixtymonitoring']['modal']['subtitle'] = "Resultaten van de tester";
...
$_LANG['store']['threesixtymonitoring']['navTab']['server'] = "Serverbewaking";
$_LANG['store']['threesixtymonitoring']['navTab']['website'] = "Bewaking van de site";
...
$_LANG['store']['threesixtymonitoring']['notifications']['tagline'] = "Wees de eerste die weet wanneer je site niet werkt of slecht presteert!";
$_LANG['store']['threesixtymonitoring']['notifications']['telegram'] = "Telegram";
$_LANG['store']['threesixtymonitoring']['notifications']['title'] = "Ontvang meldingen via je favoriete app";
$_LANG['store']['threesixtymonitoring']['notifications']['webhook'] = "Webhook";
$_LANG['store']['threesixtymonitoring']['promo']['sidebar']['body'] = "Een betrouwbare en uitgebreide bewaking van meerdere servers en meerdere locaties.";
$_LANG['store']['threesixtymonitoring']['promo']['sidebar']['title'] = "360°-bewaking";
$_LANG['store']['threesixtymonitoring']['serverDiscover']['i1'] = "360 Monitoring is <strong>open-source en aanpasbaar</strong>, zodat alle essentiële statistieken en bronnen naar behoren worden gecontroleerd om aan uw behoeften te voldoen.";
...
$_LANG['store']['threesixtymonitoring']['serverDiscover']['tagline'] = "Onze alles-in-één, paneelonafhankelijke oplossing voor beheer van meerdere servers en meerdere locaties is de sleutel om uw klanten gemoedsrust en betrouwbare bronbewaking te bieden.";
$_LANG['store']['threesixtymonitoring']['serverDiscover']['title'] = "Wat is 360 Site Monitoring?";
$_LANG['store']['threesixtymonitoring']['serverFeatures']['title'] = "Functies voor serverbewaking";
$_LANG['store']['threesixtymonitoring']['serverHeading']['tagline'] = "Bescherm de gezondheid van je server en website vandaag nog.";
$_LANG['store']['threesixtymonitoring']['serverHeading']['title'] = "Omdat uptime geld is!";
$_LANG['store']['threesixtymonitoring']['serverMonitor']['asterisk'] = "* De berekening is gebaseerd op een website die $500.000 aan inkomsten per jaar genereert, exclusief de piekseizoenen van de campagne.";
$_LANG['store']['threesixtymonitoring']['serverMonitor']['lostRevenue'] = "Omzetverlies per jaar als gevolg van downtime:";
...
$_LANG['store']['threesixtymonitoring']['websiteDiscover']['tagline'] = "Met 360 Site Monitoring behoort ongemerkte downtime tot het verleden!";
$_LANG['store']['threesixtymonitoring']['websiteDiscover']['title'] = "Wat is 360 Site Monitoring?";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i10a'] = "Scan uw Google® -lettertypen om te zien of ze aan de regels voldoen";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i10b'] = "Voldoe aan de privacywetgeving door te scannen op Google Fonts en te vermijden dat er persoonlijke gegevens van websitebezoekers worden verzameld, wat mogelijk in strijd is met de voorschriften voor gegevensbescherming.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i1a'] = "Monitoring van downtime";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i1b'] = "Ontvang direct meldingen wanneer je website offline is!";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i1c'] = "Identificeer en reageer op problemen voordat uw klanten negatief worden beïnvloed en voordat u inkomsten misloopt!";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i2a'] = "Prestatiemonitoring";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i2b'] = "Zorg ervoor dat je website sneller presteert en hoger scoort in de zoekresultaten van zoekmachines!";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i2c'] = "Controleer Time to First Byte (TTFB), DNS-tijd, verbindingstijd en totale duur.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i3a'] = "Geomonitoring";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i3b'] = "Meer informatie over locatiespecifieke problemen op je websites.";
...
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i4a'] = "Monitoring van zoekwoorden";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i4b'] = "Controleer de bronnen van de website op specifieke woorden en zinnen (bijvoorbeeld 'fout' of 'uitverkocht') en stel meldingen in voor hun aan- of afwezigheid.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i5a'] = "Poortbewaking";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i5b'] = "Controleer de responsiviteit van HTTP/S voor webverkeer, TCP voor problemen met de netwerkverbinding of firewallblokkades en ICMP (ping) voor beschikbaarheid.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i6a'] = "SSL-bewaking";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i6b'] = "Ontvang meldingen over verlopen SSL/TLS-certificaten en zorg ervoor dat uw bezoekers altijd veilig toegang hebben tot uw website.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i7a'] = "Identificeer verbroken links";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i7b'] = "Zoek en repareer verbroken links voordat ze je positie in zoekmachines beïnvloeden en een slechte klantervaring veroorzaken.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i8a'] = "Ontbrekende bedrijfsmiddelen detecteren";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i8b'] = "Ontvang meldingen over ontbrekende bestanden, ontbrekende bronnen en JavaScript-fouten die de laadtijden van pagina's kunnen vertragen, visuele inconsistenties kunnen veroorzaken en de gebruikerservaring kunnen verslechteren.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i9a'] = "Activa die invloed hebben op de prestaties";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['i9b'] = "Identificeer grote bestanden en bibliotheken die van invloed zijn op het bouncepercentage, de betrokkenheid en de conversies van je website.";
$_LANG['store']['threesixtymonitoring']['websiteFeatures']['title'] = "Hoe helpt 360 Monitoring mijn website?";
$_LANG['store']['threesixtymonitoring']['websiteHeading']['tagline'] = "Voer je URL in voor een snelle en gratis beoordeling van je website:";
$_LANG['store']['threesixtymonitoring']['websiteHeading']['title'] = "Ontdek de problemen van je website voordat je bezoekers dat doen!";
$_LANG['store']['threesixtymonitoring']['websiteMonitor']['tagline'] = "Verminder frustratie en vergroot het vertrouwen van gebruikers door gebruikers snel te waarschuwen voor problemen en updates te geven over de status van lopende incidenten.";
$_LANG['store']['threesixtymonitoring']['websiteMonitor']['title'] = "Bewaak en communiceer de status van uw website";
...
$_LANG['store']['xoviNow']['audience']['freelancersDesc'] = "XOVI NOW is ontworpen om onmiddellijke waarde te bieden voor uw persoonlijke website of de sites van uw klanten, van een eerste site-audit tot aanbevelingen om de resultaten van uw zoekmachines te verbeteren.";
$_LANG['store']['xoviNow']['audience']['freelancersTitle'] = "Freelancers";
$_LANG['store']['xoviNow']['audience']['smbizDesc'] = "Je hoeft geen SEO-expert te zijn om de Google-rankings van je bedrijf te verbeteren. XOVI NOW zal de beste zoekwoorden voor uw bedrijf identificeren en tegelijkertijd de prestaties van uw concurrenten in de gaten houden.";
$_LANG['store']['xoviNow']['audience']['smbizTitle'] = "Kleine en middelgrote bedrijven";
$_LANG['store']['xoviNow']['cartShortDescription'] = "Verbeter de prestaties van uw site met nauwkeurige, betrouwbare en gebruiksvriendelijke siteranglijsten, trefwoorden en een adviseur.";
$_LANG['store']['xoviNow']['cartTitle'] = "SEO Hulpmiddelen";
$_LANG['store']['xoviNow']['faq1'] = "Wat is SEO?";
$_LANG['store']['xoviNow']['faq10'] = "Wat is projectzichtbaarheid?";
$_LANG['store']['xoviNow']['faq10ans'] = "<p>Misschien ben je al gestopt met denken: „Wacht, maar ik geef niets om mijn zichtbaarheid voor zoekwoorden die niets met mijn bedrijf te maken hebben.” En je hebt gelijk. Zichtbaarheid is een geweldige score om een idee te krijgen van je algemene prestaties en websites in het algemeen te vergelijken, maar het is niet afgestemd op je specifieke zoekwoordenset.</p><p>Daarom bieden we <em>Project Visibility</em>. Deze statistiek wordt op dezelfde manier berekend als Zichtbaarheid, maar in plaats van 500.000 sectoroverschrijdende trefwoorden te gebruiken, is Project Visibility uitsluitend gebaseerd op trefwoorden in je Rank Tracker.</p><p>Met andere woorden, Project Visibility is een aangepaste zichtbaarheidsscore voor de unieke set trefwoorden die relevant zijn voor uw bedrijf.</p><p>Je vindt Project Visibility hier: <em>Projects → Rank Tracker → Visibility</em>.</p><p>Zoals je misschien al weet, kun je ook de ranglijsten van je concurrenten volgen in je Rank Tracker. Op die manier krijg je ook voor hen Project Visibility, waardoor een veel realistischere vergelijking mogelijk is. Dus zelfs als ze een iets ander product- of dienstenportfolio hebben, houdt Project Visibility uitsluitend rekening met trefwoorden die u daadwerkelijk deelt.</p>";
$_LANG['store']['xoviNow']['faq11'] = "Waarom is de zichtbaarheidsscore nuttig?";
...
$_LANG['store']['xoviNow']['faq12'] = "Hoe kan ik mijn zichtbaarheidsscore verbeteren?";
$_LANG['store']['xoviNow']['faq12ans'] = "<p>Kort antwoord: Maak van het verbeteren van de zichtbaarheid geen doel in je SEO-strategie.</p><p>Lang antwoord: Zichtbaarheid <em>geeft</em> de kwaliteit van je rankings weer in één enkele statistiek; het leidt niet tot betere rankings. Maak er uw doel van om uw ranking te verbeteren voor relevante zoekwoorden die potentiële klanten daadwerkelijk gebruiken om producten en diensten zoals die van u te vinden. Door je rankings te verbeteren, verbeter je ook je zichtbaarheid. Maar het is je ranking die er echt toe doet.</p><p>Als vuistregel geldt dat je zichtbaarheidsscore hoger is als</p><ul><li>De URL's van je domein op een goede positie staan</li><li>Je hebt een groot aantal geïndexeerde URL's met een goede ranking</li><li>Je scoort goed voor zoekwoorden met een hoog zoekvolume</li></ul>";
$_LANG['store']['xoviNow']['faq1ans'] = "<p>SEO is een afkorting voor Search Engine Optimization. Het is een essentiële online marketingstrategie die erop gericht is potentiële klanten naar uw website te lokken. Het doel is om een website te optimaliseren om topposities te verwerven voor geselecteerde zoekwoorden in zoekmachines. Dit doel wordt bereikt door strategisch maatregelen te nemen om de technische opzet en inhoud van de website te verbeteren en door backlinks van andere domeinen te verkrijgen.</p><p>SEO is onderverdeeld in drie algemene categorieën:</p><ol><li>Trefwoorden en ranglijsten</li><li>SEO op de pagina</li><li>Off-page SEO</li></ol><p>SEO-specialisten zijn van toepassing maatregelen om te voldoen aan de rankingfactoren van de zoekmachine voor elke categorie. Zoekmachines gebruiken rankingfactoren om de positie te bepalen waarin een website in de zoekresultaten wordt vermeld.</p>";
$_LANG['store']['xoviNow']['faq2'] = "Waarom heb ik SEO nodig?";
...
$_LANG['store']['xoviNow']['faq4'] = "Waarom zijn trefwoorden belangrijk?";
$_LANG['store']['xoviNow']['faq4ans'] = "<p><em>Keyword</em> is een technische term voor zoekopdrachten (woorden, zinnen, zinnen en vragen). Met hun hulp vinden gebruikers inhoud die hun vragen beantwoordt en oplossingen biedt. Simpel gezegd, een sleutelwoord is de link tussen gebruikers en je website. Zoekmachines vergelijken trefwoorden met websites, op zoek naar inhoud met de hoogste relevantie.</p><p>Een groot deel van SEO ligt in het identificeren van trefwoorden die het potentieel hebben om relevant verkeer naar uw website te leiden, met andere woorden, het binnenhalen van potentiële klanten. Om dat te doen, moet je zoektermen (of trefwoorden) identificeren die mensen gebruiken bij het zoeken naar aanbiedingen zoals die van jou. Dit proces heet trefwoordonderzoek. Idealiter biedt trefwoordonderzoek u een lijst met trefwoorden die betrekking hebben op zoekopdrachten gedurende het hele klanttraject.</p>";
$_LANG['store']['xoviNow']['faq5'] = "Wat is zoekwoordoptimalisatie?";
...
$_LANG['store']['xoviNow']['faq6'] = "Hoe de Advisor te gebruiken";
...
$_LANG['store']['xoviNow']['faq7'] = "Ik wil een adviseur voor andere websites. Hoe kom ik eraan?";
$_LANG['store']['xoviNow']['faq7ans'] = "<p>Houd er rekening mee dat je een <em>Project</em> nodig hebt om de Advisor-functie te laten werken. Bovendien zijn de meeste taken van de adviseur afgestemd op de website van een project (meestal die van u of die van uw klant). Als u meer dan één website beheert, moet u voor elk van deze websites een extra project aanmaken.</p><p>Om een ander project toe te voegen of naar een ander project over te schakelen, klikt u op het <em>Projects</em> menu in de bovenste navigatiebalk. Afhankelijk van je abonnement moet je het mogelijk upgraden om nog een project toe te voegen.</p>";
$_LANG['store']['xoviNow']['faq8'] = "Hoe wijs ik taken toe aan andere gebruikers?";
$_LANG['store']['xoviNow']['faq8ans'] = "<p>Als u een taak aan andere gebruikers wilt toewijzen, hebt u een abonnement nodig dat extra gebruikers toestaat. Als je abonnement extra gebruikers bevat, vind je het menu Toegewezen persoon in je adviseur en taken. Kies gewoon een gebruiker om een taak toe te wijzen of filter de Advisor op. Om een nieuwe gebruiker toe te voegen, klik op je profielavatar en vervolgens op <em>Gebruikers</em>. Als je abonnement geen extra gebruikers bevat, zie je het menu <em>Assignee</em> niet in je adviseur of taken. Upgrade je abonnement om gebruikers toe te voegen.</p>";
$_LANG['store']['xoviNow']['faq9'] = "Er zijn taken die ik al heb gedaan. Waarom duiken ze op?";
$_LANG['store']['xoviNow']['faq9ans'] = "<p>Er zijn twee redenen waarom je misschien taken ziet die je al hebt opgelost of uitgevoerd. Zoals hierboven vermeld, zijn taken een mix van elementaire SEO-maatregelen en problemen die worden aangetroffen bij wekelijkse geautomatiseerde audits van uw website.</p><p>Ten eerste zijn de taken met betrekking tot elementaire SEO-maatregelen voor iedereen hetzelfde en niet afgestemd op uw website of bedrijf. We weten bijvoorbeeld niet of je een Google-account hebt aangemaakt voor je bedrijf en Search Console hebt ingesteld of dat je SEO-plug-ins hebt geïnstalleerd. Als je dat al hebt gedaan, geweldig werk! Markeer die taken gewoon als Klaar.</p><p>De tweede reden is dat de adviseur automatisch wordt bijgewerkt op basis van de resultaten van geautomatiseerde wekelijkse site-audits. Met andere woorden, als een site-audit problemen vaststelt met betrekking tot een taak die u in het verleden hebt voltooid, wordt deze automatisch bijgewerkt en verschijnt deze in de sectie Openen.</p>";
...
$_LANG['store']['xoviNow']['featurematrix']['11'] = "Pagina's om te crawlen";
...
$_LANG['store']['xoviNow']['featurematrix']['3'] = "Accounts die alleen kunnen worden gelezen";
...
$_LANG['store']['xoviNow']['featurematrix']['6'] = "Onderzoek naar trefwoorden";
$_LANG['store']['xoviNow']['featurematrix']['7'] = "Rank Tracker";
$_LANG['store']['xoviNow']['featurematrix']['8'] = "Crawls met trefwoorden";
$_LANG['store']['xoviNow']['featurematrix']['9'] = "Controle van trefwoorden";
$_LANG['store']['xoviNow']['features']['advisor']['bullet1'] = "Taakbeheer in Kanban-stijl";
$_LANG['store']['xoviNow']['features']['advisor']['bullet2'] = "Op maat gemaakte en geprioriteerde taken";
$_LANG['store']['xoviNow']['features']['advisor']['bullet3'] = "Gedetailleerde instructies en aanvullende informatie";
$_LANG['store']['xoviNow']['features']['advisor']['bullet4'] = "Geen vakkennis nodig";
$_LANG['store']['xoviNow']['features']['advisor']['bullet5'] = "Wekelijks bijgewerkt";
$_LANG['store']['xoviNow']['features']['advisor']['line1'] = "Taken ontvangen, beheren en oplossen om je website te verbeteren";
$_LANG['store']['xoviNow']['features']['advisor']['title'] = "Adviseur";
$_LANG['store']['xoviNow']['features']['benchmarking']['bullet1'] = "Ontdek domeinen die dezelfde rangorde delen voor dezelfde zoekwoorden";
$_LANG['store']['xoviNow']['features']['benchmarking']['bullet2'] = "Identificeer de leider van uw niche";
$_LANG['store']['xoviNow']['features']['benchmarking']['bullet3'] = "Vergelijk de zoekwoordrangschikkingen van twee of meer domeinen";
$_LANG['store']['xoviNow']['features']['benchmarking']['bullet4'] = "Volg en vergelijk de ranglijsten van je concurrenten voor belangrijke zoekwoorden";
$_LANG['store']['xoviNow']['features']['benchmarking']['bullet5'] = "Zichtbaarheidsscores bijhouden en vergelijken";
$_LANG['store']['xoviNow']['features']['benchmarking']['line1'] = "Analyseer concurrenten, vergelijk prestaties en verbeter je SEO";
$_LANG['store']['xoviNow']['features']['benchmarking']['title'] = "Benchmarking";
$_LANG['store']['xoviNow']['features']['keywords']['bullet1'] = "Verkrijg uitgebreide zoekwoordgegevens";
$_LANG['store']['xoviNow']['features']['keywords']['bullet2'] = "Ontdek voor welke zoekwoorden jouw website rankt";
$_LANG['store']['xoviNow']['features']['keywords']['bullet3'] = "Identificeer veelbelovende trefwoorden voor meer bezoekers";
$_LANG['store']['xoviNow']['features']['keywords']['bullet4'] = "Analyseer de trefwoorden en ranglijsten van je concurrentie";
$_LANG['store']['xoviNow']['features']['keywords']['bullet5'] = "Internationale markten vergelijken";
$_LANG['store']['xoviNow']['features']['keywords']['bullet6'] = "Profiteer van een database met meer dan 100 miljoen trefwoorden";
...
$_LANG['store']['xoviNow']['features']['rankTracker']['bullet1'] = "Wekelijks of dagelijks essentiële ranglijsten bijhouden";
$_LANG['store']['xoviNow']['features']['rankTracker']['bullet2'] = "Lokale ranglijsten voor fysieke bedrijven";
$_LANG['store']['xoviNow']['features']['rankTracker']['bullet3'] = "Internationale ranglijsten voor internationale bedrijven";
$_LANG['store']['xoviNow']['features']['rankTracker']['bullet4'] = "Houd je concurrentie in de gaten";
$_LANG['store']['xoviNow']['features']['rankTracker']['bullet5'] = "Volg de rangschikking van trefwoorden of speciale pagina's";
$_LANG['store']['xoviNow']['features']['rankTracker']['line1'] = "Houd je rankings en die van je concurrenten in de gaten";
...
$_LANG['store']['xoviNow']['features']['siteAudit']['bullet5'] = "Vertaalde resultaten naar taken van adviseurs";
$_LANG['store']['xoviNow']['features']['siteAudit']['line1'] = "Controleer de technische basis van je website";
$_LANG['store']['xoviNow']['features']['siteAudit']['title'] = "Audit van de site";
$_LANG['store']['xoviNow']['features']['textOptimizer']['bullet1'] = "Vergelijk je tekst met de top 10 resultaten van Amazon™ en Google™";
$_LANG['store']['xoviNow']['features']['textOptimizer']['bullet2'] = "Verhoog de kwaliteit van de inhoud op een begeleide manier";
$_LANG['store']['xoviNow']['features']['textOptimizer']['bullet3'] = "Voeg trefwoorden toe, verhoog of verklein ze volgens de instructies";
$_LANG['store']['xoviNow']['features']['textOptimizer']['line1'] = "Verbeter je rankings met datagestuurde contentoptimalisatie";
$_LANG['store']['xoviNow']['features']['textOptimizer']['title'] = "Tekstoptimalisatie";
$_LANG['store']['xoviNow']['getStarted'] = "Aan de slag";
$_LANG['store']['xoviNow']['measureResults1'] = "Stel dat u uw bedrijf in het komende jaar wilt laten groeien. Je zou kunnen beginnen door wat geld te investeren in een SEO-bureau, maar dat lijkt een overweldigende taak voor iemand die geen technische vaardigheden heeft!";
$_LANG['store']['xoviNow']['measureResults2'] = ":startBold Gelukkig is er een eenvoudigere manier :endBold: laat ons ervoor zorgen dat mensen via hun online zoekopdrachten met XOVI NOW ontdekken wat JOUW bedrijf geweldig maakt.";
...
$_LANG['store']['xoviNow']['promo']['sidebar']['body'] = "Verbeter de prestaties van uw site met nauwkeurige, betrouwbare en gebruiksvriendelijke siteranglijsten, trefwoorden en een adviseur.";
$_LANG['store']['xoviNow']['promo']['sidebar']['title'] = "SEO Hulpmiddelen";
$_LANG['store']['xoviNow']['tagline'] = "Word NU online gevonden met :lineBreak XOVI";
...
$_LANG['support']['ticketError'] = "We kunnen je ticketaanvraag op dit moment niet verwerken. Probeer het later opnieuw.";
...
$_LANG['supportticketsticketid'] = "Ticketnummer";
...
$_LANG['tax']['errorService'] = "De verificatieservice :taxLabel is niet beschikbaar. Probeer het later nog eens.";
...
$_LANG['twofabackupcode'] = "Back-upcode";
...
$_LANG['usageStatsBwOverLimit'] = "Je hebt je bandbreedtelimiet overschreden.";
$_LANG['usageStatsDiskLimitNear'] = "U nadert uw opslagruimte limiet.";
$_LANG['usageStatsDiskOverLimit'] = "Je hebt de limiet voor schijfruimte overschreden.";
...
$_LANG['usagebilling']['metric']['mysqlDiskUsage'] = "MySQL-schijfgebruik";
$_LANG['usagebilling']['metric']['parkedDomains'] = "Geparkeerde domeinen";
$_LANG['usagebilling']['metric']['subAccounts'] = "Subrekeningen";
...
$_LANG['wordpress']['invalidPath'] = "Het opgegeven pad is ongeldig.";
$_LANG['wpsquared']['login'] = "Meld je aan bij WP Squared";
$_LANG['wptk']['createNew'] = "Nieuwe toevoegen";
$_LANG['wptk']['goToAdmin'] = "beheerder";
$_LANG['wptk']['goToWebsite'] = "Ga naar de website";
